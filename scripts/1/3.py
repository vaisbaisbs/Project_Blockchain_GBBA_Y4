...
# Portfolio simulation using Monte carlo  method
...
fig.update_layout(
    ...
    title=dict(
        text="Optimal Porfolio composition Proposition<br><sub>Volatility: {:.2%} | Return: {:.2%} | Sharpe: {:.2f}</sub>".format(
